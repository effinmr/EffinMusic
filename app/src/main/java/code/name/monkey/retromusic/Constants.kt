...
object Constants {
    const val WEBSITE = "https://github.com/dhruvitpokharna/EffinMusic"
    const val GITHUB_PROJECT = "https://github.com/dhruvitpokharna/EffinMusic"
    const val USER_PROFILE = "profile.jpg"
    const val USER_BANNER = "banner.jpg"
    const val FAQ_LINK = "https://github.com/dhruvitpokharna/EffinMusic/blob/master/FAQ.md"
    const val BUG = "https://github.com/dhruvitpokharna/EffinMusic/issues/new?template=bug_report.md"
    const val CHANGELOG = "https://github.com/dhruvitpokharna/EffinMusic/releases"
