...
The [issue tracker](https://github.com/dhruvitpokharna/effinmusic/issues) is the preferred channel for bug reports, feature requests and [Pull Requests](https://github.com/dhruvitpokharna/effinmusic/pulls) for submitting pull requests, but please follow these rules:
...
## License
By contributing your code, you agree to license your contribution under the [GNU General Public License](https://github.com/dhruvitpokharna/effinmusic/blob/master/LICENSE.md). 
